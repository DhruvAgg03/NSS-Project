...
// void Universe::updateOrganism(int initX, int initY, int finalX, int finalY)
// // to be shifted to organism
// {
//   auto initialPos = getObject(initX,initY);
//   auto finalPos = getObject(finalX,finalY);
//   if(finalPos!=NULL)
//   {
//     if(((Organism*)finalPos)->get_speciesID()==1)
//     {
//       cout<<"Collision with insect!"<<endl;
//       return;
//     }
//     else if (((Organism*)finalPos)->get_speciesID()==0)
//     {
//       //reduce organism energy due to movement using addEnergy method
//       ((Organism*)initialPos)->addEnergy(((Organism*)finalPos)->get_current_energy());
//     }
//   }
//   else
//   {
//     //reduce energy using addEnergyMethod
//   }
// }
